    ...
    <div className="min-h-screen bg-bg flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex justify-center mb-8">
          <div className="flex items-center gap-2 bg-ink text-chalk px-5 py-2.5 rounded-full text-sm font-bold tracking-tight shadow-ink">
        ...
        <div className="bg-surface rounded-2xl border border-border shadow-card p-8">
          ...
          <button
            ...
            className="w-full h-10 rounded-xl border border-border bg-surface hover:bg-surface2 hover:border-border2 text-sm font-semibold text-textprim flex items-center justify-center gap-2.5 transition-all mb-4"
          >
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs text-textfade font-medium">or</span>
            <div className="flex-1 h-px bg-border" />
          </div>
