...
const MF_SYMBOL_MAP = [
  ...
  ['aditya birla sun life flexi cap',              '0P0000XVWL'],
  ...
  ['axis elss tax saver',                          '0P0000XXGT'],
  ['axis long term equity',                        '0P0000XXGT'],
  ['axis nifty 50 index',                          '0P0001OF03'],
  ['axis nifty next 50',                           '0P0001OF04'],

  // Groww
  ['groww elss tax saver',                         '0P0001BN7D'],
  ['groww nifty 50',                               '0P0001BN7E'],
  ['groww flexi cap',                              '0P0001BN7F'],

  // HDFC
  ['hdfc elss tax saver',                          '0P0000XW8Z'],
  ['hdfc focused fund',                            '0P0000XW75'],
  ['hdfc nifty 100 index',                         '0P0001OF02'],
  ['hdfc nifty 50 index',                          '0P0000XW5B'],
  ['hdfc mid-cap opportunities',                   '0P0000XW6D'],
  ['hdfc mid cap opportunities',                   '0P0000XW6D'],
  ['hdfc top 100',                                 '0P0000XW73'],
  ['hdfc flexi cap',                               '0P0000XW6J'],
  ['hdfc index nifty 50',                          '0P0000XW5B'],
  ['hdfc small cap',                               '0P0000XW6E'],
  ['hdfc large and mid cap',                       '0P0000XW6B'],
  ['hdfc balanced advantage',                      '0P0000XW6G'],
  ['hdfc multi cap',                               '0P0001OF01'],
  ...
  ['icici prudential small cap',                   '0P0000XW50'],
  ['icici prudential midcap',                      '0P0000XW4Z'],
  ['icici prudential multi cap',                   '0P0000XW4Y'],
  ['icici prudential nifty 50 index',              '0P0000Z2BR'],
  ['icici prudential elss tax saver',              '0P0000XW53'],
  ['icici prudential long term equity',            '0P0000XW53'],

  // Kotak
  ['kotak emerging equity',                        '0P0000XW3T'],
  ['kotak flexicap',                               '0P0000XW3V'],
  ['kotak flexi cap',                              '0P0000XW3V'],
  ['kotak elss tax saver',                         '0P0000XW3W'],
  ['kotak small cap',                              '0P0000XW3U'],
  ['kotak bluechip',                               '0P0000XW3S'],
  ['kotak nifty 50 index',                         '0P0000XW3R'],
  ['kotak equity opportunities',                   '0P0000XW3T'],
  ['kotak multi cap',                              '0P0001OF05'],

  // Mirae Asset
  ['mirae asset large cap',                        '0P0000Y6RB'],
  ['mirae asset emerging bluechip',                '0P0001257B'],
  ['mirae asset large & midcap',                   '0P0001257B'],
  ['mirae asset large and midcap',                 '0P0001257B'],
  ['mirae asset nifty 50 index',                   '0P0001257C'],
  ['mirae asset small cap',                        '0P0001257D'],
  ['mirae asset flexi cap',                        '0P0001257E'],
  ['mirae asset elss tax saver',                   '0P0001257F'],

  // Motilal Oswal
  ['motilal oswal midcap',                         '0P0001BFSK'],
  ['motilal oswal mid cap',                        '0P0001BFSK'],
  ['motilal oswal large and midcap',               '0P0001BFSJ'],
  ['motilal oswal large & midcap',                 '0P0001BFSJ'],
  ['motilal oswal flexi cap',                      '0P0000XVWG'],
  ['motilal oswal nifty 500',                      '0P0001BFSI'],
  ['motilal oswal nifty smallcap 250',             '0P0001BFSH'],
  ['motilal oswal small cap',                      '0P0001BFSH'],
  ['motilal oswal nifty midcap 150',               '0P0001BFSK'],
  ['motilal oswal nifty next 50',                  '0P0001BFSL'],
  ['motilal oswal elss tax saver',                 '0P0001BFSM'],
  ['motilal oswal',                                '0P0001BFSK'],

  // Nippon India
  ['nippon india small cap',                       '0P0000XW9N'],
  ['nippon india gold savings',                    '0P0000XVDS'],
  ['nippon india large cap',                       '0P0000XW9F'],
  ['nippon india elss tax saver',                  '0P0000XW9G'],
  ['nippon india tax saver',                       '0P0000XW9G'],
  ['nippon india growth',                          '0P0000XW9H'],
  ['nippon india growth fund',                     '0P0000XW9H'],
  ['nippon india growth mid cap',                  '0P0000XW9H'],
  ['nippon india mid cap',                         '0P0000XW9I'],
  ['nippon india midcap',                          '0P0000XW9I'],
  ['nippon india nifty midcap 150',                '0P0001NYM1'],
  ['nippon india nifty smallcap 250',              '0P0001NYM2'],
  ['nippon india power',                           '0P0000XW9J'],
  ['nippon india power & infra',                   '0P0000XW9J'],
  ['nippon india infrastructure',                  '0P0000XW9J'],
  ['nippon india pharma',                          '0P0000XW9K'],
  ['nippon india banking',                         '0P0000XW9L'],
  ['nippon india flexi cap',                       '0P0000XW9M'],
  ['nippon india multi cap',                       '0P0000XW9O'],
  ['nippon india index nifty 50',                  '0P0000XW9P'],
  ['nippon india nifty 50',                        '0P0000XW9P'],
  ['nippon india',                                 '0P0000XW9N'],

  // Parag Parikh
  ['parag parikh flexi cap',                       '0P0000XVWF'],
  ['parag parikh conservative hybrid',             '0P0000XVWH'],
  ['parag parikh elss tax saver',                  '0P0000XVWI'],

  // Quant
  ['quant small cap',                              '0P0000Z2B7'],
  ['quant mid cap',                                '0P0000Z2B8'],
  ['quant active fund',                            '0P0000Z2B6'],
  ['quant flexi cap',                              '0P0000Z2B9'],
  ['quant large cap',                              '0P0000Z2BA'],
  ['quant elss tax saver',                         '0P0000Z2BB'],
  ['quant infrastructure',                         '0P0000Z2BC'],
  ['quant multi cap',                              '0P0000Z2BD'],
  ...
  ['sbi large & midcap',                           '0P0000XW2W'],
  ['sbi large and midcap',                         '0P0000XW2W'],
  ['sbi nifty index',                              '0P0000XW30'],
  ['sbi nifty 50',                                 '0P0000XW30'],
  ['sbi elss tax saver',                           '0P0000XW32'],
  ['sbi long term equity',                         '0P0000XW32'],
  ['sbi flexi cap',                                '0P0000XW2T'],
  ['sbi multi cap',                                '0P0001OF06'],

  // Tata
  ['tata digital india',                           '0P0001BFT3'],
  ['tata small cap',                               '0P0001BFT4'],
  ['tata mid cap growth',                          '0P0000XW1S'],
  ['tata large cap',                               '0P0000XW1T'],
  ['tata elss tax saver',                          '0P0000XW1U'],
  ['tata flexi cap',                               '0P0001BFT5'],
  ['tata nifty 50',                                '0P0001BFT6'],

  // UTI
  ['uti nifty 50 index',                           '0P0000XW1Q'],
  ['uti nifty index',                              '0P0000XW1Q'],
  ['uti flexi cap',                                '0P0000XW1R'],
  ['uti small cap',                                '0P0000XW1P'],
  ['uti mid cap',                                  '0P0000XW1O'],
  ['uti elss tax saver',                           '0P0000XW1N'],
  ['uti long term equity',                         '0P0000XW1N'],
  ['uti nifty next 50',                            '0P0000XW1M'],
  ['uti large & mid cap',                          '0P0000XW1L'],
  ['uti large and mid cap',                        '0P0000XW1L'],

  // DSP
  ['dsp small cap',                                '0P0000XW4M'],
  ['dsp mid cap',                                  '0P0000XW4L'],
  ['dsp elss tax saver',                           '0P0000XW4N'],
  ['dsp flexi cap',                                '0P0000XW4K'],
  ['dsp nifty 50 index',                           '0P0001OF07'],

  // Franklin Templeton
  ['franklin india flexi cap',                     '0P0000XW4H'],
  ['franklin india smaller companies',             '0P0000XW4I'],
  ['franklin india technology',                    '0P0000XW4J'],
  ['franklin india prima',                         '0P0000XW4G'],
  ['franklin india bluechip',                      '0P0000XW4F'],
];
